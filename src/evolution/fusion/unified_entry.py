...
class UnifiedAgent:
    ...
    async def _initialize_v2(self) -> None:
        """初始化V2服务连接"""
        try:
            from v2_project.src.core.events.event_bus import event_bus, EventBus
            from v2_project.src.core.services.service_manager import service_manager, ServiceManager
            from v2_project.src.core.config.config_manager import config_manager, ConfigManager
